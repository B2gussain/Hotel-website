...
import herovideo from "../assets/hero-video.mp4"; // your video or an image
    ...
    return (
        <section className="w-full grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col  px-4  py-10 sm::p-10 bg-white justify-center space-y-2 order-2 md:order-1">
                <h1 className="sm:text-center playfair-display lg:text-left text-3xl md:text-4xl lg:text-6xl font-extrabold text-[#4A3B33] leading-tight">
                    Experience Luxury <br />
                    & Comfort in the <br /> Heart of the City
                </h1>
                <p className="sm:text-center lg:text-left text-[20px] text-balance text-[#4A3B33]/80">
                    Discover elegant rooms, world-class dining, and exceptional
                    hospitality tailored for your perfect stay.
                </p>

                <button className="bg-[#6C4002]  hover:bg-[#6C4002] sm:w-[40%] text-white text-base sm:text-lg mt-4 py-3 px-10 rounded-xl font-semibold">
                    Book Now
                </button>
            </div>
